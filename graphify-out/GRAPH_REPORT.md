...
Cohesion: 0.08
Nodes (61): date-fns, react-day-picker, CategoriesAnalyticsPage(), CategoryPerformanceData, COLORS, CustomerPerformanceData, DailySummaryItem, ExpenseByCategoryData (+53 more)
...
Cohesion: 0.04
Nodes (69): SizePicker(), devRole, ExchangeEntry, firebaseConfig, ActivityLog, AppState, attachStaffPoll(), AVAILABLE_TAG_FORMATS (+61 more)
...
Cohesion: 0.09
Nodes (39): qrcode.react, METAL_COLORS, ProductCardProps, ViewMode, ProductWithCalculatedCosts, READY_IN, STATUS_TONE, Tab (+31 more)
...
Cohesion: 0.06
Nodes (76): @hookform/resolvers, react-hook-form, react-phone-number-input, zod, Settings: Backups, Settings: Contact Import, Settings: Hisaab Import, RevenueFormData (+68 more)
...
Cohesion: 0.07
Nodes (46): MobileToolbar(), PositionPanel(), SelectionSummary(), TemplatesPanel(), TransparencyPanel(), useThumbs(), clipboard, CONTEXT_PANELS (+38 more)

### Community 18 - "order-scanner.tsx"
Cohesion: 0.14
Nodes (26): money(), OrderScanner(), Photo, formatWeight(), GRAMS_PER_TOLA, toTola(), describeExchange(), DraftExchange (+18 more)
...
Cohesion: 0.17
Nodes (17): dynamic, gate(), GET(), PUT, catalogUrl(), getCatalogAttributes(), normalisePieceKey(), fromAttributes() (+9 more)

### Community 32 - "workshop/page.tsx"
Cohesion: 0.16
Nodes (19): STATUS_LABEL, AgeBadge(), BoardJobCard(), TakenByTag(), GlanceRow, authHeader(), fmtDate(), PullItem (+11 more)
...
### Community 34 - "react"
Cohesion: 0.09
Nodes (41): nextConfig, class-variance-authority, lucide-react, next, react, CalendarEventType, EventsByDate, AccountSummary (+33 more)
...
Cohesion: 0.09
Nodes (47): checkSame(), dynamic, gate(), maxDuration, POST(), shopName(), AiError, aiPing() (+39 more)
...
Cohesion: 0.14
Nodes (32): drawInvoice(), generateOrderSlipPDF(), alignHeadCell(), BAND, bandFor(), BRAND, drawDocFooter(), drawDocHeader() (+24 more)
...
### Community 54 - "VoiceBubble"
Cohesion: 0.10
Nodes (38): AdditionalRevenuePage(), CustomersAnalyticsPage(), AnalyticsPage(), CalendarPage(), dayMoney(), EditCustomerPage(), CustomerDetailPage(), getStatusBadgeVariant() (+30 more)

### Community 55 - "firebase"
Cohesion: 0.09
Nodes (15): firebase, app, db, app, db, firebaseConfig, db, db (+7 more)

### Community 56 - "app/customers/page.tsx"
Cohesion: 0.13
...
Cohesion: 0.17
Nodes (29): blankSalePayment(), CartPage(), day(), OrderCarryOver(), pkr(), money(), OrderForm(), promiseIn() (+21 more)
...
Cohesion: 0.09
Nodes (34): BackgroundInspector(), BrandPanel(), ColourButton(), ColourPanel(), ContextToolbar(), docColours(), EffectControls(), EffectsPanel() (+26 more)
...
Cohesion: 0.09
Nodes (43): dynamic, GET(), maxDuration, POST(), WHERES, ActionButton(), Check, CheckStatus (+35 more)

### Community 66 - "checkout.ts"
Cohesion: 0.08
Nodes (36): Before the switch goes on, Selling from taheri.shop — how it works, and what must be true before it is switched on, Testing locally, The parts, ref_node_crypto, BuildContext, buildWebsiteOrder(), BuiltOrder (+28 more)
...
Cohesion: 0.12
Nodes (27): BillScanner(), downscale(), money(), blankCartItem(), downscale(), playBeep(), QrScanner(), PhotoPick() (+19 more)
...
### Community 70 - "useAppReady"
Cohesion: 0.14
Nodes (21): ProductsAnalyticsPage(), NewSalePage(), BulkAddProductPage(), ProductsPage(), EditProductPage(), ProductDetailPage(), ScanPOSPage(), PrinterPageComponent() (+13 more)

### Community 71 - "firebase-admin.ts"
Cohesion: 0.13
...
Cohesion: 0.10
Nodes (29): ViewInvoicePage(), cartItemToOrderItem(), staticCategories, getInvoiceAdjustmentsAmount(), getInvoiceExchangeTotal(), getInvoiceExpectedGrandTotal(), InvoiceLike, OrderLike (+21 more)
...
Cohesion: 0.07
Nodes (48): ActivityLogPage(), getEventTypeColor(), GivenItemsPage(), EntityHisaabPage(), AddNewHisaabDialog(), FinalizeOrderDialog(), RecordAdvanceDialog(), ShopifyCourierOption() (+40 more)
...
Cohesion: 0.06
Nodes (80): @radix-ui/react-label, Settings: Printer (Zebra), Settings: WePrint API, eventIcons, REVERTABLE_EVENTS, revertConsequences, EstimatedInvoice, INVOICE_COLUMNS (+72 more)
...
Cohesion: 0.15
Nodes (12): lines(), monogram, STORE_EST_MARGIN, STORE_MARK_SVG, STORE_MONOGRAM_SVG, STORE_POST_FOOTER, STORE_POST_METAL, STORE_POST_TAGLINE (+4 more)
...
Cohesion: 0.08
Nodes (49): dynamic, GET(), DELETE(), dynamic, fail(), idOk(), maxDuration, PATCH() (+41 more)

### Community 94 - "cn"
Cohesion: 0.04
Nodes (51): @radix-ui/react-accordion, @radix-ui/react-menubar, @radix-ui/react-radio-group, EventDetails(), AddTransactionDialog(), compactPKR(), Headline(), OngoingOrderRow() (+43 more)
...
Cohesion: 0.32
Nodes (9): src_app_globals, AppBody(), inter, applyThemeToDocument(), DEVICE_THEME_EVENT, LIGHT_THEME, readCachedTheme(), readDeviceTheme() (+1 more)

### Community 106 - "links/page.tsx"
Cohesion: 0.17
Nodes (6): Channel, didone, IconName, Utility, STORE_COMMUNITIES, STORE_LOGO_LIGHT_URL
...
Cohesion: 0.10
Nodes (31): dynamic, maxDuration, POST(), dynamic, GET(), maxDuration, dynamic, GET() (+23 more)

### Community 114 - "website/pricing.ts"
Cohesion: 0.12
Nodes (26): ref_node_path, vitest, Body, dynamic, OPTIONS(), POST(), configReadiness(), loadRates() (+18 more)
...
### Community 119 - "format"
Cohesion: 0.16
Nodes (15): RevenueForm(), ClosedBatchCard(), DirectPaymentsCard(), day(), daysLate(), emptyPiece(), HandBackDialog(), pkr() (+7 more)
...
### Community 126 - "shrink-order-sample-images.mjs"
Cohesion: 0.22
...
### Community 142 - "sync/order/route.ts"
Cohesion: 0.50
...
### Community 158 - "check-outstanding.mjs"
Cohesion: 0.40
Nodes (3): app, db, firebaseConfig

### Community 159 - "OrderDetailPage"
Cohesion: 0.14
Nodes (21): getStatusBadgeVariant(), OrderDetailPage(), EditCartItemDialog(), n(), toDraft(), toPatch(), categorySingular(), describeDelivery() (+13 more)
...
Cohesion: 0.05
Nodes (60): bodyFace, cinzel, cormorant, FONTS, headlineFace, montserrat, playfair, script (+52 more)

### Community 163 - "dispatch"
Cohesion: 0.50
...
### Community 185 - "clear-shopify.mjs"
Cohesion: 0.50
Nodes (3): app, db, firebaseConfig
...
### Community 195 - "FromSitePage"
Cohesion: 0.33
Nodes (7): agoLabel(), authHeaders(), daysAgo(), FromSitePage(), host(), listOf(), validWeight()

### Community 198 - "order-slip-pdf.ts"
Cohesion: 0.13
Nodes (20): jspdf, jspdf-autotable, drawItemCell(), ItemBlock, itemCellHeight(), line(), wastageGrams(), wastageLine() (+12 more)

### Community 199 - "DayCard"
Cohesion: 0.29
Nodes (8): AddByHand(), authHeaders(), autoLine(), DayCard(), hhmm(), InvestmentsPage(), longDate(), time()

### Community 205 - "MyWorkPage"
Cohesion: 0.50
Nodes (4): fmt(), MyWorkPage(), OrderGroupedJobs(), groupJobsByOrder()

## Knowledge Gaps
- **1221 isolated node(s):** `privateKey`, `db`, `dump`, `ts`, `$schema` (+1216 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 1495 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **20 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `firebase` connect `firebase` to `import-shopify-customers.mjs`, `utils.ts`, `add-bank-account.mjs`, `store.ts`, `delete-bad-invoices.mjs`, `diagnose-dbs.mjs`, `import-shopify-orders.mjs`, `fix-dates.mjs`, `fix-invoice-dates.mjs`, `package.json`, `link-all-karigar-expenses.mjs`, `link-invoice-hisaab.mjs`, `link-uzair-expenses.mjs`, `restore-orders.mjs`, `restore-settings.mjs`, `write/route.ts`, `fix-bareeka.mjs`, `add-bareeka-invoice.mjs`, `add-uzair-skipped-entries.mjs`, `delete-sherbano-invoice.mjs`, `diagnose-orders.mjs`, `do-refund-fatima.mjs`, `link-uzair-stones.mjs`, `check-outstanding.mjs`, `google-auth-gate.tsx`, `list-invoices.mjs`, `add-mina-payment.mjs`, `react`, `settings/page.tsx`, `preview-karigar-links.mjs`, `add-ali-customer.mjs`, `add-order-1141.mjs`, `sync-hisaab-balances.mjs`, `reset-and-reimport.mjs`, `fix-invoice-skus.mjs`, `check-refunded-invoices.mjs`, `refund-fatima.mjs`, `clear-shopify.mjs`, `clean-hisaab.mjs`, `renumber-zahra.mjs`, `check-counters.mjs`, `import-expenses.mjs`, `inspect-zahra.mjs`, `restore-inv-000001.mjs`, `backfill-payment-credits.mjs`, `ShareholderFinancesPage`, `backfill-source-orders.mjs`, `fix-overwritten-invoices.mjs`, `working-capital-floor.tsx`, `order-form.tsx`, `link-new-karigars.mjs`, `fix-zahra-invoice.mjs`?**
  _High betweenness centrality (0.306) - this node is a cross-community bridge._
- **Why does `next` connect `react` to `utils.ts`, `voice-bubble.tsx`, `google-auth-gate.tsx`, `settings/page.tsx`, `orders/[id]/page.tsx`, `write/route.ts`, `package.json`, `sync/order/route.ts`, `vision/order/route.ts`, `whatsapp.ts`, `fulfilment.ts`, `investments.ts`, `pieces/route.ts`, `workshop/page.tsx`, `post/page.tsx`, `verifyRequestEmail`, `run/route.ts`, `roleForEmail`, `workshop.ts`, `website/featured/route.ts`, `ai/route.ts`, `_lib.ts`, `app-layout.tsx`, `middleware.ts`, `app/customers/page.tsx`, `OrderForm`, `health.ts`, `firebase-admin.ts`, `public/me/route.ts`, `order-form.tsx`, `instagram.ts`, `queue.ts`, `command-palette.tsx`, `photos/route.ts`, `listen/route.ts`, `app/layout.tsx`, `links/page.tsx`, `shopifyRequest`, `gold-rates/route.ts`, `tcs/route.ts`, `caption/route.ts`, `website/pricing.ts`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `utils.ts`, `voice-bubble.tsx`, `store.ts`, `settings/page.tsx`, `orders/[id]/page.tsx`, `package.json`, `story-editor.tsx`, `openWhatsApp`, `DocumentsPage`, `investments.ts`, `OrderDetailPage`, `workshop/page.tsx`, `react`, `post/page.tsx`, `run/route.ts`, `app-layout.tsx`, `toast.tsx`, `chart.tsx`, `newLayerId`, `VoiceBubble`, `DocumentCard`, `app/customers/page.tsx`, `OrderForm`, `editor-panels.tsx`, `ShareholderFinancesPage`, `design.ts`, `health.ts`, `ProductForm`, `FromSitePage`, `Designer`, `bill-scanner.tsx`, `DayCard`, `working-capital-floor.tsx`, `useAppStore`, `MyWorkPage`, `order-form.tsx`, `overheads.ts`, `queue-panel.tsx`, `dropdown-menu.tsx`, `searchable-picker.tsx`, `format`, `sheet.tsx`?**
