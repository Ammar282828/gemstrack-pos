...
import { STORE_LOGO_URL, STORE_LOGO_LIGHT_URL, STORE_LINKS, STORE_PARTNERSHIP, STORE_WEBSITE_WEIGHTS, STORE_INVESTMENTS } from '@/lib/store-config';
  ...
  },
  {
    ...
    items: [
      ...
      ...(STORE_LINKS.website ? ([
        ...
        ...(STORE_INVESTMENTS ? [{ staff: true, href: '/website/investments', label: 'Investments', icon: <TrendingUp /> }] : []),
